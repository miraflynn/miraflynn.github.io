...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Olin College of Engineering}{Aug. 2019 -- May 2023}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Data Analytics and Management Intern}{Jun. 2022 -- Aug. 2022}
      {Pfizer}{}
      \resumeItemListStart
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{National High Injury Network Analysis Tool} $|$ \emph{Python, Flask, SQL, AWS, NumPy, Pandas}}{Sep. 2022 -- May 2023}\\
          \resumeItemListStart
